...
<div class="container">
	...
	<div class="col_12">
		<p style="color: blue; font-size: 15px; text-align: center">Jampa
			...
			deste site, você poderá organizar a sua vida.</p>
	</div>

	<div class="botoesprincipais">
		<a class="button blue pop" href="<c:url value="/entrar"/>"> Entrar</a>
		<a class="button pop" href="/condomino/cadastro"> Cadastro -
			Condômino</a>
	</div>

	<!-- Slideshow -->
	<ul class="slideshow">
		<li><img src="<c:url value="/design/images/predio.jpg"/>"
			width="550" height="500" /></li>
		<li><img src="<c:url value="/design/images/predio2.jpg"/>"
			width="550" height="500" /></li>
		<li><img src="<c:url value="/design/images/familia.jpg"/>"
			width="550" height="500" /></li>
	</ul>
</div>
<h:footer/>
